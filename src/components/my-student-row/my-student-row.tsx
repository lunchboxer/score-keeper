  ...
  render() {
    ...
    return (
      ...
      <tr class={"student" + this.student.id }>
        <td>
          <span onClick={this.addStarHandler.bind(this)} class="studentName" data-id={this.student.id}>{this.student.name}</span>
          <span onClick={this.removeStarHandler.bind(this)} class="removeStar" data-id={this.student.id}>&times;</span>
        </td>

        <td class={"student" + this.student.id + " stars"}>
          {this.buildScoresArray().map(id => (
            <my-star rank={id}></my-star>
          ))}
        </td>

        <td class={"student" + this.student.id + " score"}>
          {this.score}
        </td>
      </tr>
    )
